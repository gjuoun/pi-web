export const THEME_OPTIONS = [
  ...
  { id: "github", label: "settings.themeGithub" },
  { id: "dracula", label: "settings.themeDracula" },
...
// Palettes that also carry the `.dark` class, so `dark:` utilities and color-scheme follow them.
const DARK_THEMES: readonly ResolvedTheme[] = ["dark", "dracula"];
