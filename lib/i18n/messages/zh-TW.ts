...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "設定",
    "settings.general": "一般",
    "settings.generalDescription": "選擇介面的外觀與語言。",
    "settings.appearance": "外觀",
    "settings.appearanceDescription": "選擇淺色或深色主題，也可以跟隨系統設定。",
    "settings.uiFont": "介面字型",
    "settings.monoFont": "等寬字型",
    "settings.resetUiFont": "重設介面字型",
    "settings.resetMonoFont": "重設等寬字型",
    "settings.fontPlaceholder": "跟隨系統預設",
    "settings.fontSuggestions": "顯示字型建議",
    "settings.fontNoMatches": "沒有符合的建議 — 可直接輸入本機已安裝的字型名稱",
    "settings.fontDefaultBadge": "內建字型堆疊",
    "settings.fontHint": "填寫本機已安裝的字型名稱；字型缺少時回退到內建字型堆疊。等寬字型同時作用於程式碼區塊與工作區終端機。",
    "settings.messageWidth": "訊息寬度",
    "settings.chatContentFontSize": "聊天字體大小",
    "settings.resetMessageWidth": "重設訊息寬度",
    "settings.resetChatContentFontSize": "重設聊天字體大小",
    "settings.messageWidthDescription": "設定訊息內容的最大寬度。輸入框佔滿整欄。",
    ...
    "settings.completionSound": "任務完成時播放提示音",
    ...
    "settings.reloadRequired": "重新載入目前工作階段後生效。",
    "subagent.open": "開啟子代理工作階段",
    "piSubagents.title": "子代理（外掛）",
    "piSubagents.empty": "本工作階段還沒有跑在 pi-subagents 引擎上的任務。",
    "piSubagents.notEnabled": "本工作階段未啟用 pi-subagents 引擎。請在 pi 的 settings 中啟用該套件，或使用開啟擴充功能的對話。",
    "piSubagents.openSession": "開啟該任務的對話",
    "piSubagents.sessionPending": "子工作階段尚未就緒",
    "piSubagents.turns": "輪",
    "piSubagents.tools": "次工具",
    "piSubagents.tokens": "tokens",
    "piSubagents.status.starting": "排隊中",
    "piSubagents.status.running": "執行中",
    "piSubagents.status.steered": "已插話",
    "piSubagents.status.completed": "已完成",
    "piSubagents.status.error": "失敗",
    "piSubagents.status.aborted": "已中止",
    ...
    "appUpdate.releaseNotes": "v{version} 已推出，查看版本資訊",
    "sidebar.hide": "隱藏側邊欄",
    "sidebar.show": "顯示側邊欄",
    "theme.light": "主題：淺色",
    "theme.dark": "主題：深色",
    ...
    "sidebar.pinnedSection": "已置頂",
    "sidebar.dateBucketToday": "今天",
    "sidebar.dateBucketYesterday": "昨天",
    "sidebar.dateBucketPrevious7Days": "過去 7 天",
    "sidebar.dateBucketOlder": "更早",
    ...
    "chat.steer": "引導",
    "chat.followUp": "後續訊息",
    "chat.steerHint": "作為引導排隊，目前回合工具執行完後投遞",
    "chat.followUpHint": "在 Agent 完成後排入此訊息",
    "chat.queueHint": "Enter 排隊引導 · Alt+Enter 排隊後續 · Esc 中斷",
    ...
    "chat.commandModel": "選擇模型（開啟選擇器）",
    "chat.commandThinking": "設定思考層級",
    "chat.pickerNoMatch": "無相符項目",
    "chat.compacted": "已壓縮",
