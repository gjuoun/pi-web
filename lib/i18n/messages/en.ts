...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.generalDescription": "Choose how the interface looks and which language it uses.",
    ...
    "settings.resetUiFont": "Reset interface font",
    "settings.resetMonoFont": "Reset monospace font",
    "settings.fontPlaceholder": "System default",
    "settings.fontSuggestions": "Show font suggestions",
    "settings.fontNoMatches": "No suggestion matches — type any installed font name",
    "settings.fontDefaultBadge": "Built-in stack",
    "settings.fontHint": "Type a font installed on this device; a missing font falls back to the built-in stack. The monospace font also drives code blocks and the workspace terminal.",
    "settings.messageWidth": "Message width",
    "settings.chatContentFontSize": "Chat font size",
    "settings.resetMessageWidth": "Reset message width",
    "settings.resetChatContentFontSize": "Reset chat font size",
    "settings.messageWidthDescription": "Set the maximum width of messages. The input spans the full column.",
    "settings.themeLight": "Light",
    "settings.themeDark": "Dark",
    "settings.themeGithub": "GitHub",
    ...
    "settings.completionSound": "Play a sound when a run finishes",
    ...
    "settings.reloadRequired": "Reload the current session to apply this change.",
    "subagent.open": "Open sub-agent session",
    "piSubagents.title": "Sub-agents (package)",
    "piSubagents.empty": "No runs on the pi-subagents engine in this session yet.",
    "piSubagents.notEnabled": "The pi-subagents engine is not enabled for this session. Enable the package in pi's settings, or use a session with extensions.",
    "piSubagents.openSession": "Open this run's session",
    "piSubagents.sessionPending": "The child session is not known yet",
    "piSubagents.turns": "turns",
    "piSubagents.tools": "tools",
    "piSubagents.tokens": "tokens",
    "piSubagents.status.starting": "Starting",
    "piSubagents.status.running": "Running",
    "piSubagents.status.steered": "Steered",
    "piSubagents.status.completed": "Completed",
    "piSubagents.status.error": "Failed",
    "piSubagents.status.aborted": "Aborted",
    ...
    "appUpdate.releaseNotes": "v{version} is available. View release notes",
    ...
    "sidebar.dateBucketToday": "Today",
    "sidebar.dateBucketYesterday": "Yesterday",
    "sidebar.dateBucketPrevious7Days": "Previous 7 Days",
    "sidebar.dateBucketOlder": "Older",
    ...
    "chat.steerHint": "Queue this message as steering, delivered after the current turn's tool calls",
    "chat.followUpHint": "Queue this message after the agent finishes",
    "chat.queueHint": "Enter queues a steer · Alt+Enter queues a follow-up · Esc aborts",
    ...
    "chat.commandModel": "Select model (opens selector UI)",
    "chat.commandThinking": "Set thinking level",
    "chat.pickerNoMatch": "No matches",
