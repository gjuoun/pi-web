...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "agents.close": "Close",
    "agents.builtInTitle": "Enable built-in sub-agents",
    "agents.builtInDescription": "Provides the integrated Agent tools and disables a conflicting pi-subagents extension.",
