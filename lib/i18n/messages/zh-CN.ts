...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.title": "设置",
    "settings.general": "常规",
    "settings.generalDescription": "选择界面显示方式和语言。",
    "settings.appearance": "外观",
    "settings.appearanceDescription": "选择浅色或深色主题，也可以跟随系统设置。",
    "settings.uiFont": "界面字体",
    "settings.monoFont": "等宽字体",
    "settings.resetUiFont": "重置界面字体",
    "settings.resetMonoFont": "重置等宽字体",
    "settings.fontPlaceholder": "跟随系统默认",
    "settings.fontSuggestions": "显示字体建议",
    "settings.fontNoMatches": "没有匹配的建议 — 可直接输入本机已安装的字体名称",
    "settings.fontDefaultBadge": "内置字体栈",
    "settings.fontHint": "填写本机已安装的字体名称；字体缺失时回退到内置字体栈。等宽字体同时作用于代码块与工作区终端。",
    "settings.messageWidth": "消息宽度",
    "settings.chatContentFontSize": "聊天字体大小",
    "settings.resetMessageWidth": "重置消息宽度",
    "settings.resetChatContentFontSize": "重置聊天字体大小",
    "settings.messageWidthDescription": "设置消息内容的最大宽度。输入框占满整列。",
    ...
    "settings.completionSound": "任务完成时播放提示音",
    ...
    "settings.reloadRequired": "重新加载当前会话后生效。",
    "subagent.open": "打开子代理会话",
    "piSubagents.title": "子代理（插件）",
    "piSubagents.empty": "本会话还没有跑在 pi-subagents 引擎上的任务。",
    "piSubagents.notEnabled": "本会话未启用 pi-subagents 引擎。请在 pi 的 settings 里启用该包，或使用开启了扩展的会话。",
    "piSubagents.openSession": "打开该任务的会话",
    "piSubagents.sessionPending": "子会话尚未就绪",
    "piSubagents.turns": "轮",
    "piSubagents.tools": "次工具",
    "piSubagents.tokens": "tokens",
    "piSubagents.status.starting": "排队中",
    "piSubagents.status.running": "运行中",
    "piSubagents.status.steered": "已插话",
    "piSubagents.status.completed": "已完成",
    "piSubagents.status.error": "失败",
    "piSubagents.status.aborted": "已中止",
    "piSubagents.status.stopped": "已停止",
    "piSubagents.status.unknown": "未知",
    "agentSwitcher.title": "Agents",
    "agentSwitcher.enginePackage": "插件",
    ...
    "appUpdate.releaseNotes": "v{version} 可用，查看更新说明",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "主题：浅色",
    "theme.dark": "主题：深色",
    ...
    "sidebar.dateBucketPrevious7Days": "过去 7 天",
    ...
    "chat.steer": "引导",
    "chat.followUp": "后续消息",
    "chat.steerHint": "作为引导排队，当前回合工具执行完后投递",
    "chat.followUpHint": "在 Agent 完成后排队此消息",
    "chat.queueHint": "Enter 排队引导 · Alt+Enter 排队后续 · Esc 中断",
    ...
    "chat.commandModel": "选择模型（打开选择器）",
    "chat.commandThinking": "设置思考级别",
    "chat.pickerNoMatch": "无匹配项",
    "chat.compacted": "已压缩",
