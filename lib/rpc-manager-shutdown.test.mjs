...
test("direct bash commands use pi's own shell execution", async (t) => {
  let received;
  ...
  // No pi-web-specific operations: the SDK's built-in shell execution (including its own
  // `shellPath` / `shellCommandPrefix` handling) runs the command.
  assert.equal(received.options.operations, undefined);
});
